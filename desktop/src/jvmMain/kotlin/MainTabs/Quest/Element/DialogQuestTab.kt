...
//                                println("---------------")
//                                println("it.index: ${itemInfo.index}")
//                                println("it.offset: ${itemInfo.offset}")
//                                println("it.size: ${itemInfo.size}")
//                                println("viewportEndOffset: ${stateList.layoutInfo.viewportEndOffset}")
                                if (itemInfo.offset >=0 && (itemInfo.offset + itemInfo.size) <= stateList.layoutInfo.viewportEndOffset) key = false
                            }
