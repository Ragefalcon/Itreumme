            ...
            mainSpis = { modifierList, selection, openSpis_Index_Item, lazyListState, dialLay ->
                MainDB.styleParam.avatarParam.skillTab.itemSkill.getComposable(::ItemSkillsTreeState){ itemStyle ->
                    MyList(
                        ...
                        if (itemTreeSkill.stat != TypeStatTreeSkills.INVIS) ComItemTreeSkills(itemTreeSkill,
                            selection,
                            openTree = {
...
//                                                    StateVM.selectionTreeSkills.selected = null
                                ...
                                TypeStatTreeSkills.COMPLETE -> {}/*TODO()*/
                                TypeStatTreeSkills.UNBLOCKNOW -> visibMenu()
                                TypeStatTreeSkills.BLOCK -> {}
                                TypeStatTreeSkills.INVIS -> {}
                            }
            ...
            openedItem = { itemTS, startOpenAnimation, selection, dialLay ->
                if (dialLay != null) ComItemTreeSkillsOpened(dialLay, itemTS,
                    openTree = {
