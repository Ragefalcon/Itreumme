    ...
    fun show() {
        Column(Modifier.padding(top = 8.dp), horizontalAlignment = Alignment.CenterHorizontally) {
            MainDB.styleParam.timeParam.vxodTab.itemVxod.getComposable(::ItemVxodStyleState) { vxodStyle ->
                MyList(MainDB.timeSpis.spisVxod, Modifier.padding(top = 5.dp).weight(1f), listState) { ind, itemVxod ->
            ...
            Row(
                modifier = Modifier.padding(bottom = 5.dp, top = 15.dp).padding(horizontal = 20.dp),
                ...
                MyTextButtStyle1(
                    ...
                    width = 60.dp,
                    height = 60.dp,
                    myStyleTextButton = TextButtonStyleState(MainDB.styleParam.timeParam.vxodTab.buttAddVxod)
                ) {
                    PanAddVxod(dialLay)
                }
            }
